...
def main(data_root, ont):
    ...
    test_data_file = f'{data_root}/{ont}/time_data.pkl'
    ...
    with open(f'data/{ont}/sprof/time_data_all_preds.txt') as f:
        data = f.read().split('\n\n')    
        ...
        if ont == 'bp':
            ...
            ont_ind = 6
            k = 2
        sprof_terms = headers[ont_ind + k].split('; ')
    ...
    test_df['preds'] = preds
    test_df.to_pickle(f'{data_root}/{ont}/time_predictions_sprof.pkl')
